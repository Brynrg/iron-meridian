...
const ALLIANCE: MissionSpec[] = [
  ...
  },
  {
    ...
    make: ([p, e]) => ({
      ...
      actors: [
        ...
        { type: "heavytank", owner: 1, tx: e!.x + 4, ty: e!.y + 3 },
      ],
      objectives: [
        ...
        { id: "timer", kind: "flag", hidden: true, text: "Survive until the relief column arrives." },
      ],
      triggers: [
        startMsg("Command: Engineers capture on contact. Keep them alive."),
        { id: "held", when: { kind: "objectiveDone", id: "cap" }, actions: [{ kind: "activate", id: "hold" }, { kind: "activate", id: "timer" }, { kind: "timer", seconds: 300, label: "Relief column" }, { kind: "message", text: "Pact armour inbound. Hold for five minutes." }] },
  ...
  },
  {
    ...
    make: ([p, e]) => ({
      ...
      objectives: [{ id: "cash", kind: "credits", amount: 12000, text: "Accumulate 12,000 credits." }, protectYard()],
  ...
  },
  {
    ...
    map: { seed: 9005, width: 64, height: 64, waterAmount: 0.75, oreAmount: 0.6, players: 2 },
    make: ([, e]) => ({
      players: [human("alliance", 8000), enemy("pact", true, "normal", 6000)],
      techLevel: 4,
      actors: [...base(1, e!, 2, "pact"), { type: "sub", owner: 1, tx: e!.x, ty: e!.y + 12, count: 2 }],
      objectives: [{ id: "yard", kind: "buildType", type: "navalyard", text: "Build a Naval Yard on the shore." }, { id: "pen", kind: "destroyType", owner: 1, type: "subpen", text: "Destroy the Submarine Pen." }, destroyAll(1)],
  ...
  },
  {
    ...
    index: 8,
    title: "Chokepoint",
    briefing: ["Three Arc Towers guard the only road through the mountains. Artillery outranges them; bring it forward under escort.", "Then clear the garrison."],
    map: { seed: 9008, width: 56, height: 56, waterAmount: 0.05, oreAmount: 0.5, players: 2 },
    make: ([, e]) => ({
      players: [human("alliance", 9000), enemy("pact", true, "normal", 5000)],
      techLevel: 5,
      actors: [...base(1, e!, 2, "pact"), { type: "arctower", owner: 1, tx: e!.x - 9, ty: e!.y - 8 }, { type: "arctower", owner: 1, tx: e!.x - 10, ty: e!.y + 2 }, { type: "arctower", owner: 1, tx: e!.x - 2, ty: e!.y - 10 }],
      objectives: [{ id: "towers", kind: "destroyType", owner: 1, type: "arctower", count: 3, text: "Destroy the three Arc Towers." }, destroyAll(1)],
  ...
  },
  {
    ...
    make: ([, e]) => ({
      players: [human("alliance", 10000), enemy("pact", true, "hard", 12000)],
      techLevel: 7,
  ...
  },
  {
    ...
    index: 12,
    title: "Shockwave",
    briefing: ["The Pact Missile Silo is armed. Capture it before the ten-minute launch window closes, or your base will be gone.", "Engineers with an armoured escort. Go now."],
    ...
    make: ([p, e]) => ({
      ...
      techLevel: 8,
      actors: [...base(1, e!, 3, "pact"), { type: "missilesilo", owner: 1, tx: e!.x + 8, ty: e!.y - 2 }, { type: "engineer", owner: 0, tx: p!.x + 3, ty: p!.y + 3, count: 3 }, { type: "apc", owner: 0, tx: p!.x + 5, ty: p!.y + 3 }],
      ...
      triggers: [
        startMsg("Command: ten minutes. Load the Engineers into the APC."),
        { id: "t", when: { kind: "start" }, actions: [{ kind: "timer", seconds: 600, label: "Launch window" }] },
  ...
  },
  {
    ...
    make: ([, e]) => ({
      players: [human("alliance", 12000), enemy("pact", true, "hard", 14000)],
      techLevel: 9,
      actors: base(1, e!, 3, "pact"),
  ...
  },
  {
    ...
    make: ([, e1, e2]) => ({
      players: [human("alliance", 15000), enemy("pact", true, "hard", 16000, 1), enemy("pact", true, "hard", 12000, 1, "#8a2a2a")],
      techLevel: 10,
      actors: [...base(1, e1!, 3, "pact"), ...base(2, e2!, 3, "pact"), { type: "missilesilo", owner: 1, tx: e1!.x + 8, ty: e1!.y - 2 }],
...
const PACT: MissionSpec[] = [
  ...
  },
  {
    ...
    map: { seed: 8005, width: 64, height: 64, waterAmount: 0.75, oreAmount: 0.6, players: 2 },
    make: ([, e]) => ({
      players: [human("pact", 8000), enemy("alliance", true, "normal", 6000)],
      techLevel: 4,
      actors: [...base(1, e!, 2, "alliance"), { type: "gunboat", owner: 1, tx: e!.x, ty: e!.y + 12, count: 2 }],
      objectives: [{ id: "pen", kind: "buildType", type: "subpen", text: "Build a Submarine Pen." }, { id: "yard", kind: "destroyType", owner: 1, type: "navalyard", text: "Destroy the Naval Yard." }, destroyAll(1)],
  ...
  },
  {
    ...
    make: ([p, e]) => ({
      ...
      noStartingUnits: true,
      techLevel: 7,
      actors: [{ type: "officer", owner: 0, tx: p!.x, ty: p!.y }, { type: "shock", owner: 0, tx: p!.x - 1, ty: p!.y + 2, count: 2 }, { type: "rifle", owner: 0, tx: p!.x + 1, ty: p!.y + 2, count: 3 }, ...base(1, e!, 2, "alliance"), { type: "techcenter", owner: 1, tx: e!.x + 6, ty: e!.y + 6 }, { type: "camopillbox", owner: 1, tx: e!.x + 4, ty: e!.y + 9 }],
  ...
  },
  {
    ...
    make: ([, e]) => ({
      players: [human("pact", 9000), enemy("alliance", true, "normal", 6000)],
      techLevel: 5,
  ...
  },
  {
    ...
    make: ([, e]) => ({
      players: [human("pact", 10000), enemy("alliance", true, "hard", 12000)],
      techLevel: 7,
  ...
  },
  {
    ...
    make: ([, e]) => ({
      players: [human("pact", 12000), enemy("alliance", true, "hard", 14000)],
      techLevel: 9,
      actors: base(1, e!, 3, "alliance"),
  ...
  },
  {
    ...
    make: ([, e1, e2]) => ({
      players: [human("pact", 15000), enemy("alliance", true, "hard", 16000, 1), enemy("alliance", true, "hard", 12000, 1, "#2a4a8a")],
      techLevel: 10,
